...
#include "../../test1/histogramwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FrameProcessor_t, stringdata) + ofs \
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_HistogramWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
