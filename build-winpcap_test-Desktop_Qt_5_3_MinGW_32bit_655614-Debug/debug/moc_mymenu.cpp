...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyMenu_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 53, 14)
    ...
    "MyMenu\0about\0\0endProgram\0hideAndShow\0"
    "startDectecting\0stopDectecting"
};
...
void MyMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->hideAndShow(); break;
        case 3: _t->startDectecting(); break;
        case 4: _t->stopDectecting(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MyMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_MyMenu.data,
      qt_meta_data_MyMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyMenu.stringdata))
