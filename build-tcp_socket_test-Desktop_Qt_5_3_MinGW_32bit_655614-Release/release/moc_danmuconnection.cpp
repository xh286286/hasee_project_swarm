...
void DanmuConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messReady(); break;
        case 1: _t->getHttpInfo(); break;
        ...
        {
            typedef void (DanmuConnection::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DanmuConnection::messReady)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void DanmuConnection::messReady()
{
